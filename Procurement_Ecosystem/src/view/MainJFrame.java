...
public class MainJFrame extends javax.swing.JFrame {
        ...
        public MainJFrame() {
                ...
                // call DB API (just need endpoint and request body)
                // DBApiUtil.callDB();
        ...
        private void initComponents() {
                ...
                layout.setHorizontalGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(MenuPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 900,
                                                                Short.MAX_VALUE)
                                                .addComponent(userProcessContainer,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
        ...
        private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnLoginActionPerformed
                ...
                switch (role) {
                        ...
                        // This would have some problem, you call network.getEnterpriseDir(); in
                        // constructor, but the use haven't login yet.
                        // if you create another network, this will cause unexpected behavior!!
                        // recommend you use Session.getCurrentNetwork() to get the network in Shipment
                        // UI
