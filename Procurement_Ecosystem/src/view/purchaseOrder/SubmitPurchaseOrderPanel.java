...
public class SubmitPurchaseOrderPanel extends javax.swing.JPanel implements IDataRefreshCallbackAware {
        ...
        private void handleCreatePObtn() {
                UIUtil.getSelectedTableObject(
                                ...
                                .ifPresent(q -> {
                                        ...
                                        Result<Void> r = ProcurementController.getInstance().handlePOSubmit(selectedRFQ,
                                                        q, txtPrice.getText(), txtRemarks.getText(),
                                                        txtAddress.getText());
                                        if (!r.isSuccess()) {
        ...
        private void loadRFQComboBox() {
                ...
                // Filter with Quotation status is Completed inside closed RFQ
                List<RFQ> ready4PO = closedRFQ.stream()
                                .filter(rfq -> rfq.getQuotations().isQuotationCompleted())
                                .collect(Collectors.toList());
        ...
        private void refreshPOTable() {
                ...
                System.out.println("PO size: "
                                + AppContext.getUserEnterprise().getPurchaseOrderList().getPurchaseOrderList().size());
